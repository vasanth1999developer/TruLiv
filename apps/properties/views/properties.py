...
from apps.properties.models.properties import Amenity, Property, PropertyAmenity, PropertyRoomType, PropertyScheduleVisit, RoomType, TimeSlot
from apps.properties.serializers.properties import AmenityListSerializer, AmenitySerializer, PropertyAmenitySerializer, PropertyLATandLONSerializer, PropertyListSerializer, PropertyRetriveSerializer, PropertyRoomListSerializer, PropertyRoomRetriveSerializer, PropertyRoomTypeSerializer, PropertySerializer, RoomTypeListSerializer, RoomTypeSerializer, ScheduleVistListSerilizer, ScheduleVistSerilizer, TimeSlotListSerializer, TimeSlotSerializer
...
class PropertiesListViewSet(AppModelListAPIViewSet):
    ...
    filterset_fields = ["location", "related_property_room_types__room_type__name", "related_property_room_types__price_per_month"]
        ...
        nearby_places = [
            {
                ...
                "distance_km": round(self.haversine(latitude, longitude, float(place.latitude), float(place.longitude)),2),
            }
