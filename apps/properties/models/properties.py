...
from apps.common.models.base import COMMON_BLANK_AND_NULLABLE_FIELD_CONFIG, COMMON_CHAR_FIELD_MAX_LENGTH, COMMON_NULLABLE_FIELD_CONFIG, BaseCreationModel, BaseModel, IdentityBaseModel
...
class Property(IdentityBaseModel):
    ...
    ********************************  Model Fields ********************************
    pk                  - id
    uuid                - uuid
    charField           - property_name, property_city, property_area, property_location, property_janitor, property_address, property_gender
    ...
    phonenumber = AppPhoneNumberField(**COMMON_BLANK_AND_NULLABLE_FIELD_CONFIG, unique=True)
...
class PropertyAmenity (BaseModel):
    ...
    ********************************  Model Fields ********************************
    ...
    class Meta(BaseModel.Meta):
        ...
        constraints = [
            models.UniqueConstraint(fields=['property', 'amenity'], name='unique_property_amenities')
        ]
...
class PropertyRoomType(BaseModel):
    ...
    ********************************  Model Fields ********************************
    ...
    class Meta(BaseModel.Meta):
        ...
        constraints = [
            models.UniqueConstraint(fields=['property', 'room_type'], name='unique_property_room_type')
        ]        
    ...
    class Meta(BaseModel.Meta):
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['property_room_type', 'bed_number'], 
