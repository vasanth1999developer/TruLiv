...
from apps.properties.views.properties import AmenityCUDViewSet, AmenityListViewSet, NearbyPropertiesView, PropertiesListViewSet, PropertyAmenityViewSet, PropertyCUDViewSet, PropertyRetriveViewSet, PropertyRoomListViewSet, PropertyRoomRegistrationViewSet, PropertyRoomRetriveViewSet, PropertyScheduleVistViewSet, RoomTypeListViewSet, RoomTypesCUDViewSet, ScheduleVistListOfUserViewSet, TimeSlotCUDViewSet, TimeSlotListViewSet
...
router.register(f"{API_URL_PREFIX}property-room-registration", PropertyRoomRegistrationViewSet, basename="property-room-registration")
...
router.register(f"{API_URL_PREFIX}schedule-visit-list", ScheduleVistListOfUserViewSet, basename="schedule-visit-of-user")
