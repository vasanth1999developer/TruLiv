...
from apps.properties.models.properties import Amenity, Bed, Property, PropertyAmenity, PropertyRoomType, PropertyScheduleVisit, RoomType, TimeSlot
...
class PropertyRoomListSerializer(AppReadOnlyModelSerializer):
    ...
    class Meta(AppReadOnlyModelSerializer.Meta):
        model = PropertyRoomType
        fields = ["id", "property", "room_type", "number_of_rooms", "price_per_month", "total_capacity", "is_bed_available"]     
